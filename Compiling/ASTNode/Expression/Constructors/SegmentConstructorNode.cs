...
namespace Compiling
{
    public class SegmentConstructorNode : Expression
    {
        Expression p1;
        Expression p2;
        

        public SegmentConstructorNode(CodeLocation location, Expression p1,Expression p2 )
        {
            this.p1 = p1;
            this.p2 = p2;
