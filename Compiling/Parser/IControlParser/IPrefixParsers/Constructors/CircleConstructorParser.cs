...
namespace Compiling
{
    public class CircleConstructorParser:IPrefixParser
    {
        public CircleConstructorParser(KeyParser parser)
        {
            Register(parser);
        }
        public Expression Parse(KeyParser parser, Token token, List<CompilingError> errors)
        {
            ...
            }
            {
                ...
                }
                {
                    ...
                    return new CircleConstructorNode(token.Location,p1, p2);
