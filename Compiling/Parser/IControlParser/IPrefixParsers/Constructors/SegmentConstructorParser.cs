...
namespace Compiling
{
    public class SegmentConstructorParser : IPrefixParser
    {
        public SegmentConstructorParser(KeyParser parser)
        {
            Register(parser);
        }
        public Expression Parse(KeyParser parser, Token token, List<CompilingError> errors)
        {
            ...
            }
            {
                ...
                }
                {
                    ...
                    {
                        return new SegmentConstructorNode(token.Location,p1, p2);
                    }
                }
            }
